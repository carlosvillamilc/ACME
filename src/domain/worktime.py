...
class Worktime:
    ...
    def get_shift(self) -> list:
        ...
        for shift_hour in shift_hours:
            if shift_hours[shift_hour][1] > hours[0] >= shift_hours[shift_hour][0]:
                starting_shift = shift_hour                
            if shift_hours[shift_hour][1] >= hours[1] > shift_hours[shift_hour][0]:
    ...
    def get_hours_shift(self,shift:list)->list:
        ...
        if shift[0] != shift[1]:            
            ...
            finish_shift_time = finish_hour.hour - finish_hour_starting_shift.hour
